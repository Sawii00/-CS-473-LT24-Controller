	soc_system u0 (
		...
		.lcd_output_data_out                 (<connected-to-lcd_output_data_out>),                 //                   lcd_output.data_out
		.lcd_output_command_data             (<connected-to-lcd_output_command_data>),             //                             .command_data
		.lcd_output_write                    (<connected-to-lcd_output_write>),                    //                             .write
		.lcd_output_chipselect               (<connected-to-lcd_output_chipselect>),               //                             .chipselect
		.lcd_output_reset_x                  (<connected-to-lcd_output_reset_x>)                   //                             .reset_x
	);
