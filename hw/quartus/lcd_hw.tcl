...
add_fileset_file DMAController.vhd VHDL PATH ../hdl/DMAController.vhd
add_fileset_file LCDController.vhd VHDL PATH ../hdl/LCDController.vhd
add_fileset_file RegisterFile.vhd VHDL PATH ../hdl/RegisterFile.vhd
add_fileset_file fifo.vhd VHDL PATH ../hdl/fifo.vhd
add_fileset_file reg_pkg.vhd VHDL PATH ../hdl/reg_pkg.vhd
...
add_interface_port slave address_slave address Input 7
add_interface_port slave read_slave read Input 1
add_interface_port slave readdata_slave readdata Output 16
...
add_interface_port conduit_end D data_out Output 16
add_interface_port conduit_end D_CX command_data Output 1
add_interface_port conduit_end WRX write Output 1
add_interface_port conduit_end CSX chipselect Output 1
add_interface_port conduit_end RESX reset_x Output 1
